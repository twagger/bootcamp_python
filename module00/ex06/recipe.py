...
while choice != '5':
	...
	while choice not in ['1', '2', '3', '4', '5']:
		choice = input("\033[1;35mPlease select an option (1 to 5):\n\033[0m>> ")
	if choice == '1':
		add_recipe_from_input(cookbook)
	elif choice == '2':
		recipe_name = input("\033[1;35mPlease enter the recipe name to delete:\n\033[0m>> ")
		delete_recipe(cookbook, recipe_name)
	elif choice == '3':
		recipe_name = input("\033[1;35mPlease enter a recipe name to get its details:\n\033[0m>> ")
